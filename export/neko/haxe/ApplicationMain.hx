...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("PachloDemo1", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("PachloDemo1", null, 683, 384);
		#end
		#else
		create (null);
		#end
		...
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed (projectName, null, 683, 384, config);
		#end
		#else
		create (config);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["file"] = "PachloDemo1";
		app.meta["name"] = "PachloDemo1";
